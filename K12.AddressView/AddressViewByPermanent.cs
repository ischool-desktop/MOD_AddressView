...
{
    //依畢業年度檢視
    public partial class AddressViewByPermanent : NavView
    {
        ...
        void NoteView_SourceChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt = queryHelper.Select("select id,name,permanent_address from student where id in('" + qh + "')");
            ...
            Node1.Text = "依戶籍地址檢視(" + Source.Count() + ")";
            Node1.Tag = "All";
